...
const styles = StyleSheet.create({
  page: { paddingTop: 0, paddingHorizontal: 0, paddingBottom: 66, fontSize: 9.5, fontFamily: 'Helvetica', color: INK, backgroundColor: '#ffffff', lineHeight: 1.45 },

  // Zwarte kopbalk met logo
  ...
  // Meta (rechts bovenin)
  metaWrap: { alignItems: 'flex-end', marginBottom: 22 },
  ...
  tGrand: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 9, paddingHorizontal: 10, marginTop: 6, backgroundColor: BAR, borderRadius: 4 },
  ...
  // Footer
  footer: { position: 'absolute', bottom: 28, left: 44, right: 44, borderTop: `1 solid ${LINE}`, paddingTop: 10 },
    ...
    <Document title={`Factuur ${invoiceNumber}`} author="Vami Pro">
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.topBar}>
          ...
          <Text style={styles.barTitle}>FACTUUR</Text>
        </View>
